...
//                        when (columnNumber) {
//                            0 -> fullName = myCell.toString()
//                            1 -> shortName = myCell.toString()
//                            2 -> runnerSex = if(myCell.toString() == "М") RunnerSex.MALE else RunnerSex.FEMALE
//                            3 -> city = myCell.toString()
//                            4 -> phone = myCell.toString()
//                            5 -> dateOfBirthday = myCell.toString().toDate()
//                            6 -> number = myCell.toString().toBigDecimal().toInt()
//                            7 -> teamName = myCell.toString()
//                        }
//                        columnNumber++
//                    }
//                    if(number != null){
